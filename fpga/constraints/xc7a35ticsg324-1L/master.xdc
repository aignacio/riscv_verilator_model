...
## JA1
## JA2
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports tx_mirror_o]
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports rx_mirror_i]
