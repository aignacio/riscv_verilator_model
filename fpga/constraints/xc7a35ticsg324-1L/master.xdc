...
set_property -dict {PACKAGE_PIN A10 IOSTANDARD LVCMOS33} [get_ports {sw_in[3]}]

## RGB LEDs
set_property -dict {PACKAGE_PIN E1 IOSTANDARD LVCMOS33} [get_ports {rgb_led_0[2]}]
set_property -dict {PACKAGE_PIN F6 IOSTANDARD LVCMOS33} [get_ports {rgb_led_0[1]}]
set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS33} [get_ports {rgb_led_0[0]}]

set_property -dict {PACKAGE_PIN G4 IOSTANDARD LVCMOS33} [get_ports {rgb_led_1[2]}]
set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33} [get_ports {rgb_led_1[1]}]
set_property -dict {PACKAGE_PIN G3 IOSTANDARD LVCMOS33} [get_ports {rgb_led_1[0]}]

set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports {rgb_led_2[2]}]
set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS33} [get_ports {rgb_led_2[1]}]
set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33} [get_ports {rgb_led_2[0]}]

set_property -dict {PACKAGE_PIN K2 IOSTANDARD LVCMOS33} [get_ports {rgb_led_3[2]}]
set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33} [get_ports {rgb_led_3[1]}]
set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports {rgb_led_3[0]}]
...
## Pmod Header JD
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports scl]
set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33} [get_ports sda]
# set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { jtag_tck_io }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
# set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
# set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33  PULLUP TRUE } [get_ports { uart_tx }]; #IO_L14P_T2_SRCC_35 Sch=jd[7]
# set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33  PULLUP TRUE } [get_ports { jtag_tms_io }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
# set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33  PULLUP TRUE } [get_ports { SRST_n }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
